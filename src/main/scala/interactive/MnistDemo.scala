...
//          override protected def getL1(layer: Layer): Double = layer match {
//            case _ : FullyConnectedLayer ⇒ -0.001
//            case _ ⇒ 0.0
//          }
//
//          override protected def getL2(layer: Layer): Double = 0.0
//
...
//      .set(Java8Util.cvt(() ⇒ 0.001 * (Random.nextDouble() - 0.5)))).addTo(monitoringRoot, "synapse"))
