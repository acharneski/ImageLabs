...
//}
//
//class DownsamplingModel(source: String, server: StreamNanoHTTPD, out: HtmlNotebookOutput apply ScalaNotebookOutput) extends MindsEyeNotebook(server, out) {
//
...
//      case Array(source) ⇒ new DownsamplingModel(source, server, out).apply()
//      case _ ⇒ new DownsamplingModel("E:\\testImages\\256_ObjectCategories", server, out).apply()
//    })
//
//  }
//
